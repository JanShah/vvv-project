...
function getContent(items,hash) {
	...
	if(hash&&hash!=='#products') {
		...
		if(category.length===2) {
			...
			//e	verything product related is now abstracted to Product prototypes
